<template>
  <div class="alert-keyboard" ref="boxKeyBoard" v-show="keyShow">
    <ul class="keyboard">
      <li
...
export default {
  ...
  mounted() {
    ...
    // this.$refs.boxKeyBoard.style.left = clientWidth / 2 + "px";
    // this.$refs.boxKeyBoard.style.marginLeft =-50;
  },
  methods: {
    clickKey(key) {
      switch (key) {
